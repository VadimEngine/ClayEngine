...
class GraphicsAPIOpenGLES : public IGraphicsAPI {
public:
    ...
    inline GLenum ToGLCullMode(GraphicsAPIOpenGLES::CullMode cullMode) {
        switch (cullMode) {
            case GraphicsAPIOpenGLES::CullMode::NONE:
                return GL_BACK;
            case GraphicsAPIOpenGLES::CullMode::FRONT:
                return GL_FRONT;
            case GraphicsAPIOpenGLES::CullMode::BACK:
                return GL_BACK;
            case GraphicsAPIOpenGLES::CullMode::FRONT_AND_BACK:
    ...
    inline GLenum ToGLBlendOp(GraphicsAPIOpenGLES::BlendOp op) {
        switch (op) {
            case GraphicsAPIOpenGLES::BlendOp::ADD:
                return GL_FUNC_ADD;
            case GraphicsAPIOpenGLES::BlendOp::SUBTRACT:
                return GL_FUNC_SUBTRACT;
            case GraphicsAPIOpenGLES::BlendOp::REVERSE_SUBTRACT:
                return GL_FUNC_REVERSE_SUBTRACT;
            case GraphicsAPIOpenGLES::BlendOp::MIN:
                return GL_MIN;
            case GraphicsAPIOpenGLES::BlendOp::MAX:
                return GL_MAX;
            default:
                return 0;
        }
    ...
    inline GLenum ToGLStencilCompareOp(GraphicsAPIOpenGLES::StencilOp op) {
        switch (op) {
            case GraphicsAPIOpenGLES::StencilOp::KEEP:
                return GL_KEEP;
            case GraphicsAPIOpenGLES::StencilOp::ZERO:
                return GL_ZERO;
            case GraphicsAPIOpenGLES::StencilOp::REPLACE:
                return GL_REPLACE;
            case GraphicsAPIOpenGLES::StencilOp::INCREMENT_AND_CLAMP:
                return GL_INCR;
            case GraphicsAPIOpenGLES::StencilOp::DECREMENT_AND_CLAMP:
                return GL_DECR;
            case GraphicsAPIOpenGLES::StencilOp::INVERT:
                return GL_INVERT;
            case GraphicsAPIOpenGLES::StencilOp::INCREMENT_AND_WRAP:
                return GL_INCR_WRAP;
            case GraphicsAPIOpenGLES::StencilOp::DECREMENT_AND_WRAP:
                return GL_DECR_WRAP;
            default:
                return 0;
        }
    ...
    inline GLenum ToGLBlendFactor(GraphicsAPIOpenGLES::BlendFactor factor) {
        switch (factor) {
            case GraphicsAPIOpenGLES::BlendFactor::ZERO:
                return GL_ZERO;
            case GraphicsAPIOpenGLES::BlendFactor::ONE:
                return GL_ONE;
            case GraphicsAPIOpenGLES::BlendFactor::SRC_COLOR:
                return GL_SRC_COLOR;
            case GraphicsAPIOpenGLES::BlendFactor::ONE_MINUS_SRC_COLOR:
                return GL_ONE_MINUS_SRC_COLOR;
            case GraphicsAPIOpenGLES::BlendFactor::DST_COLOR:
                return GL_DST_COLOR;
            case GraphicsAPIOpenGLES::BlendFactor::ONE_MINUS_DST_COLOR:
                return GL_ONE_MINUS_DST_COLOR;
            case GraphicsAPIOpenGLES::BlendFactor::SRC_ALPHA:
                return GL_SRC_ALPHA;
            case GraphicsAPIOpenGLES::BlendFactor::ONE_MINUS_SRC_ALPHA:
                return GL_ONE_MINUS_SRC_ALPHA;
            case GraphicsAPIOpenGLES::BlendFactor::DST_ALPHA:
                return GL_DST_ALPHA;
            case GraphicsAPIOpenGLES::BlendFactor::ONE_MINUS_DST_ALPHA:
    ...
    inline GLenum ToGLTopology(GraphicsAPIOpenGLES::PrimitiveTopology topology) {
        switch (topology) {
            case GraphicsAPIOpenGLES::PrimitiveTopology::POINT_LIST:
                return GL_POINTS;
            case GraphicsAPIOpenGLES::PrimitiveTopology::LINE_LIST:
                return GL_LINES;
            case GraphicsAPIOpenGLES::PrimitiveTopology::LINE_STRIP:
                return GL_LINE_STRIP;
            case GraphicsAPIOpenGLES::PrimitiveTopology::TRIANGLE_LIST:
                return GL_TRIANGLES;
            case GraphicsAPIOpenGLES::PrimitiveTopology::TRIANGLE_STRIP:
                return GL_TRIANGLE_STRIP;
            case GraphicsAPIOpenGLES::PrimitiveTopology::TRIANGLE_FAN:
    ...
    inline GLenum ToGLCompareOp(GraphicsAPIOpenGLES::CompareOp op) {
        switch (op) {
            case GraphicsAPIOpenGLES::CompareOp::NEVER:
                return GL_NEVER;
            case GraphicsAPIOpenGLES::CompareOp::LESS:
                return GL_LESS;
            case GraphicsAPIOpenGLES::CompareOp::EQUAL:
                return GL_EQUAL;
            case GraphicsAPIOpenGLES::CompareOp::LESS_OR_EQUAL:
                return GL_LEQUAL;
            case GraphicsAPIOpenGLES::CompareOp::GREATER:
                return GL_GREATER;
            case GraphicsAPIOpenGLES::CompareOp::NOT_EQUAL:
                return GL_NOTEQUAL;
            case GraphicsAPIOpenGLES::CompareOp::GREATER_OR_EQUAL:
                return GL_GEQUAL;
            case GraphicsAPIOpenGLES::CompareOp::ALWAYS:
                return GL_ALWAYS;
            default:
                return 0;
        }
    ...
    GraphicsAPIOpenGLES(XrInstance m_xrInstance, XrSystemId systemId);
...
public:
    ...
    void bindBuffer(IGraphicsAPI::BufferTarget target, unsigned int bufferId) override;

    void bufferData(IGraphicsAPI::BufferTarget target, size_t size, void* data, IGraphicsAPI::DataUsage usage) override;
    ...
    void drawElements(IGraphicsAPI::PrimitiveTopology mode, int count, IGraphicsAPI::DataType type, const void* indices) override;
    ...
    void texParameter(IGraphicsAPI::TextureTarget target, IGraphicsAPI::TextureParameterType paramName, IGraphicsAPI::TextureParameterOption paramOption) override;

    void texImage2D(IGraphicsAPI::TextureTarget target,
                    unsigned int level,
                    IGraphicsAPI::TextureFormat internalFormat,
                    unsigned int width,
                    unsigned int height,
                    unsigned int border,
                    IGraphicsAPI::TextureFormat format,
                    IGraphicsAPI::DataType dataType,
                    const void * data) override;

    void getTexImage(IGraphicsAPI::TextureTarget target, unsigned int level, IGraphicsAPI::TextureFormat format, DataType type, void* pixels) override;

    void bindTexture(IGraphicsAPI::TextureTarget target, unsigned int textureId) override;

    void pixelStore(IGraphicsAPI::PixelAlignment alignment, unsigned int value) override;

    void activeTexture(unsigned int textureUnit) override;

    void bindBufferRange(IGraphicsAPI::BufferTarget target, unsigned int index, unsigned int buffer, size_t offset, size_t size) override;

    void genFrameBuffers(unsigned int count, unsigned int* fbos) override;

    void framebufferTexture2D(IGraphicsAPI::FrameBufferTarget target, unsigned int attachment, IGraphicsAPI::FBOTextureTarget texTarget, unsigned int textureId, unsigned int level) override;

    void genRenderBuffer(unsigned int n, unsigned int* rbos) override;

    void bindRenderBuffer(IGraphicsAPI::RenderBufferTarget target, unsigned int renderBuffer) override;

    void renderBufferStorage(IGraphicsAPI::RenderBufferTarget target, IGraphicsAPI::RenderBufferFormat format, unsigned int width, unsigned int height) override;

    void frameBufferRenderBuffer(IGraphicsAPI::FrameBufferTarget frameBufferTarget, IGraphicsAPI::FrameBufferAttachment attachment, IGraphicsAPI::RenderBufferTarget renderBufferTarget, unsigned int rbo) override;

    void drawBuffers(unsigned int n, unsigned int* bufs) override;

    void bufferSubData(IGraphicsAPI::BufferTarget target, size_t offset, size_t size, const void* data) override;

    void drawArrays(IGraphicsAPI::PrimitiveTopology mode, unsigned int start, unsigned int count) override;

    void clearBuffers(const std::vector<IGraphicsAPI::ClearBufferTarget>& targets) override;
